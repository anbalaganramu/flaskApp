## Solution by Anbalagan R

# GitHub Gist API Proxy

- Endpoint: `GET /<username>`
- Returns public gists for any GitHub user.
- Runs on port 8080 in Docker.

## To test:
1. `docker build -t gist-api .`
2. `docker run -p 8080:8080 gist-api`
3. `curl http://localhost:8080/octocat`

This implementation fulfills the assignment:
- Exposes `GET /<USER>` returning public gists
- Includes automated test using `octocat`
- Dockerized on port 8080

## :warning: Please read these instructions carefully and entirely first
* Clone this repository to your local machine.
* Use your IDE of choice to complete the assignment.
* When you have completed the assignment, you need to  push your code to this repository and [mark the assignment as completed by clicking here](https://app.snapcode.review/submission_links/ed390b65-a1f8-40e8-899c-21d588a45b27).
